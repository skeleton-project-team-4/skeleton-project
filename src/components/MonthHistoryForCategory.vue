<template>
    <div class="box m-3">
      <div class="mt-3 fw-bold fs-3 d-flex justify-content-center">{{ currentMonth }}월 통계</div>
      <div class="d-flex justify-content-start align-items-center">
        <div class="mx-3 me-5 mt-5 chart-wrapper">
        ...
        <div class="flex-column d-flex justify-content-between">
          <div
            ...
            :key="key"
          >
            <div class="fs-5 pe-3 d-flex align-items-center gap-2">
              <font-awesome-icon
                v-if="icons[key]"
                :icon="icons[key]"
            ...
            <div class="fs-5 ps-3">{{ value }}원</div>
          </div>
        </div>
      </div>
    </div>
